...
$LoadedData .='<li class="galleryMainImage" style="position: absolute; left: 0px; top: 0px; animation-duration: 0.620164s;">
	<a href="assets/images/gallery/'. $rowGallery["gallery_main_image"] .'" class="fancybox" data-fancybox-group="gallery"><img src="assets/images/gallery/thumbnail/'. $rowGallery['gallery_thumnail_image'] .'">
		<div class="caption">
